...
\begin{equation}
	\mathcal{Z}_{\leq k } = \sum_{v \in V} \mathcal{1}{|\mathcal{C}(v)| \leq k}
\end{equation}
...
\begin{lemma}
	$\mathbb{P}_{\lambda}(|\mathcal{C}_{\max}| \leq a \log n) \longrightarrow_{n \to \infty} 0 \quad, a>I_{\lambda}^{-1}$
\end{lemma}
...
\begin{proof}
	...
	\begin{proof}
		...
		\begin{align}
			\mathbb{P}_{\lambda}(|\mathcal{C}(i)| \geq k, |\mathcal{C}(j)| \geq k) 
			&= \sum_{l=k}^{n} \mathbb{P}_{\lambda}(|\mathcal{C}(i)| = k, |\mathcal{C}(j)| \geq k) \\
			&= \sum_{l=k}^{n} \mathbb{P}_{\lambda}(|\mathcal{C}(i)| = k)\mathbb{P}( |\mathcal{C}(j)| \geq k | |\mathcal{C}(i)| = l) 
		\end{align}
		...
		\begin{align}
			\mathbb{P}_{\lambda}(|\mathcal{C}(i)| \geq k, |\mathcal{C}(j)| \geq k) 
			&\leq \sum_{l=k}^{n} \mathbb{P}_{\lambda}(|\mathcal{C}(i)| = k)\mathbb{P}( |\mathcal{C}(j)| \geq k ) \\
			&\leq \mathbb{P}( |\mathcal{C}(j)| \geq k ) \sum_{l=k}^{n} \mathbb{P}_{\lambda}(|\mathcal{C}(i)| = k) \\
		...
		\begin{align}
		\mathbb{Z}_{\geq k} &=  \sum_{C \in \Gamma} \sum_{i \in C} (\sum_{j \in C}(\mathbb{P}_{\lambda}(|\mathcal{C}(i)| \geq k, |\mathcal{C}(j)| \geq k)
			-\mathbb{P}_{\lambda}(|\mathcal{C}(i)| \geq k)\mathbb{P}_{\lambda}(|\mathcal{C}(j)| \geq k)) \\
