...
For the beginning we will use the recent approach from Sudakov (TODO : ADD REF ) which makes use of an algorithm of graph exploration called the depth first search (DFS).
