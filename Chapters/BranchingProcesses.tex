...
\begin{proof}
	...
	\begin{proof}
		...
		\begin{equation}
			\mathbb{V}(Z_{\geq}) \leq \sum_{i,j \in V} \mathbb{P}_{\lambda}(|\mathcal{C}(i)|\geq k, i \leftrightarrow j)
		\end{equation}
		And using properties of the expectation (linearity and behaviour in regard of indicator function ) we have
		\begin{align}
		\mathbb{V}(Z_{\geq}) &\leq \sum_{i \in V}\sum_{j \in V} \mathbb{E}_{\lambda} ( \mathbbm{1}_{\lambda}(|\mathcal{C}(i)|\geq k\mathbbm{1}_{j \in \mathcal{C}(i)})) \\
				     &\leq \sum_{i \in V} \mathbb{E}_{\lambda} ( \mathbbm{1}_{\lambda}(|\mathcal{C}(i)|\geq k\sum_{j\in V} \mathbbm{1}_{j \in \mathcal{C}(i)})) \\
				     &\leq \sum_{i \in V} \mathbb{E}_{\lambda} ( \mathbbm{1}_{\lambda}(|\mathcal{C}(i)|\geq k\sum_{j\in V} |\mathcal{C}(i)|)) 
		\end{align}
	\end{proof}
\end{proof}
