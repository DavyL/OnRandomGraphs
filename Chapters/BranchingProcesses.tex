...
In this critical window there will be with positive probability there is never more than one complex component (Janson, Knuth, Luczak and Pittel (TODO: ADD REF), proved that this probability is exactly $\frac{5\pi}{18}$), and the largest component will be of size about $n^{2/3}$.
There are still open questions on the different ways the phase transition happens.
