...
\newline
This process is called \emph{Breadth first search} and might be referred as BFS.
\newline
...
\newline
In fact there exists stronger results that use the same method but make a use of martingales in order to get a really sharph result on the asymptotic size of the greatest connected component, see Bollob\'as and Riordan \cite{BollobRiordan12}. (TODO : ADD THE RESULT ? PROVE IT ?)
\newline
