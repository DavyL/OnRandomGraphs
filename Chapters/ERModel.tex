...
\begin{proof}
	...
	\begin{align}
		...
		&\leq 2n^{-\frac{K^2}{9}}
	\end{align}
	If we combine the last inequality that is obtained applying the previous lemma with \ref{bayes} then we have the result.
\end{proof}
\begin{theorem}
...
\begin{proof}
	...
	\begin{theorem}
		$\lim{n \to \infty) \mathbb{E}_r(X_n) - \lambda^r = 0$
			\newline
